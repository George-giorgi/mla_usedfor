...
type anymation = boolean;

const WelderSVG = (props: { anim: anymation }) => {
  return (
    <div className={`${props.anim ? style.fadein : ""}`}>
      <svg
        className={""}
        version="1.0"
        ...
        width="432.000000pt"
        height="360.000000pt"
        viewBox="0 0 432.000000 360.000000"
      ...
      >
        <g
          ...
          fill={"#f8fafc"}
          className={
            props.anim ? " transition-all duration-1000 animate-pulse" : ""
          }
          stroke={props.anim ? "red" : "none"}
        >
          <path
            d="M1693 3219 c-203 -34 -393 -193 -468 -392 -25 -68 -48 -199 -44 -250
...
-15 10 3 8 6 21 6 29 0 16 9 18 28 6z"
          />
          <path
            d="M850 2060 c0 -11 12 -26 29 -35 17 -8 31 -25 33 -37 5 -35 33 -29 33
7 0 21 -7 33 -24 41 -13 7 -28 20 -33 28 -13 23 -38 20 -38 -4z"
          />
          <path
            d="M982 1937 c-37 -44 -52 -149 -33 -217 7 -24 8 -24 15 10 4 19 24 68
44 108 28 57 34 77 26 90 -14 22 -38 26 -52 9z"
          />
          <path
            d="M767 1862 c-8 -13 5 -57 34 -112 25 -47 32 -126 17 -200 l-7 -35 14
30 c22 47 18 135 -10 222 -28 87 -40 110 -48 95z"
          />
          <path
            d="M770 1700 c28 -57 35 -63 26 -25 -4 17 -16 39 -28 50 -19 19 -19 18
2 -25z"
          />
          <path
            d="M744 1681 c20 -29 36 -60 36 -69 0 -8 3 -13 6 -9 12 12 -17 74 -48
103 l-31 29 37 -54z"
          />
          <path
            d="M886 1567 c-83 -130 -103 -226 -23 -114 57 80 77 125 67 152 -6 17
-12 12 -44 -38z"
          />
          ...
          <path
            d="M2436 2815 c-4 -102 -11 -244 -16 -317 -18 -256 -20 -309 -10 -253
30 162 66 625 54 703 -13 86 -21 47 -28 -133z"
          />
          <path
            d="M1673 2978 c-18 -5 -33 -10 -33 -11 0 -2 23 -27 51 -57 156 -166 257
-374 293 -605 7 -50 14 -76 15 -58 2 54 -19 182 -45 272 -29 102 -103 259
-174 370 -62 97 -66 100 -107 89z"
          />
          <path
            d="M2502 2924 c-1 -17 -4 -47 -7 -65 l-5 -34 11 34 c5 18 8 47 6 65 l-4
31 -1 -31z"
          />
          ...
          <path
            d="M1735 2329 c-19 -29 25 -142 53 -137 22 4 26 27 12 77 -15 57 -49 88
-65 60z"
          />
          <path d="M2483 2265 c0 -27 2 -38 4 -22 2 15 2 37 0 50 -2 12 -4 0 -4 -28z" />
          <path
            d="M1825 2187 c-12 -27 -47 -34 -66 -11 -12 14 -15 8 -26 -52 -9 -49
...
262 178 372 26 27 52 60 59 72 12 24 14 78 3 105 -7 16 -8 16 -17 -5z"
          ...
          <path
            d="M2373 2045 c-11 -8 -66 -96 -122 -195 -80 -142 -109 -183 -134 -196
-27 -14 -62 -16 -246 -13 -193 4 -216 2 -219 -12 -5 -26 25 -29 278 -29 l236
0 61 103 c34 56 92 159 128 230 65 124 69 148 18 112z"
          />
          <path
            d="M1816 1968 c-45 -82 -121 -267 -112 -275 11 -11 368 -32 392 -23 26
10 72 84 147 236 l54 110 -171 0 c-94 -1 -194 2 -223 7 l-52 8 -35 -63z"
          />
          <path
            d="M1767 1948 c-50 -90 -99 -190 -95 -193 2 -2 33 55 71 126 69 133 86
177 24 67z"
          />
          <path
            d="M3154 1894 c-8 -20 -14 -42 -12 -49 2 -8 10 8 19 36 18 57 15 65 -7
13z"
          />
          <path d="M3073 1690 c0 -41 2 -58 4 -37 2 20 2 54 0 75 -2 20 -4 3 -4 -38z" />
          <path
            d="M3301 1701 c-29 -56 -26 -65 5 -13 14 24 24 46 21 49 -3 3 -15 -13
-26 -36z"
          />
          <path d="M2971 1714 c0 -11 3 -14 6 -6 3 7 2 16 -1 19 -3 4 -6 -2 -5 -13z" />
          <path
            d="M3997 1673 c-34 -27 -83 -82 -76 -86 2 -1 30 24 61 56 32 31 56 57
55 57 -2 0 -20 -12 -40 -27z"
          />
          <path
            d="M2982 1665 c0 -16 6 -52 13 -80 l14 -50 -5 45 c-3 25 -9 61 -14 80
-8 34 -8 34 -8 5z"
          />
          <path
            d="M2891 1616 c9 -12 23 -32 32 -46 10 -13 17 -19 17 -12 0 7 -15 27
-32 45 -18 18 -26 24 -17 13z"
          />
          <path
            d="M3379 1585 c-11 -25 -19 -50 -17 -55 2 -6 13 15 25 45 26 66 20 73
-8 10z"
          />
          <path
            fill="#f8fafc"
            d="M4110 1613 c-27 -10 -100 -66 -100 -77 0 -5 12 2 28 16 15 14 45 35
67 46 37 20 40 28 5 15z"
          ...
          <path
            d="M1796 1529 c40 -9 139 -9 194 -1 29 5 -3 7 -89 7 -74 0 -121 -3 -105
-6z"
          />
          <path
            d="M2749 1525 c5 -11 26 -38 46 -60 26 -29 31 -32 16 -10 -30 44 -74 93
-62 70z"
          />
          <path
            d="M1745 1515 c22 -8 58 -13 80 -13 32 0 26 3 -30 13 -87 17 -101 17
-50 0z"
          />
          <path
            fill="#E20816"
            d="M3664 1471 c-21 -16 -55 -46 -74 -67 -32 -36 -31 -35 15 6 28 25 64
55 80 67 17 12 27 23 24 23 -3 0 -24 -13 -45 -29z"
          />
          <path
            d="M3156 1420 c8 -43 14 -51 14 -19 0 13 -5 31 -10 39 -7 11 -8 5 -4
-20z"
          />
          <path
            fill="#E20816"
            d="M3252 1435 c-1 -11 3 -38 7 -60 l9 -40 0 35 c0 19 -4 46 -8 60 -6 20
-8 21 -8 5z"
          />
          <path
            d="M2954 1376 c12 -30 23 -52 25 -50 5 5 -29 93 -38 99 -5 2 1 -20 13
-49z"
          />
          <path
            fill="#E20816"
            d="M3044 1395 c3 -9 15 -47 27 -86 12 -38 23 -68 25 -66 6 6 -45 167
-53 167 -3 0 -2 -7 1 -15z"
          />
          <path
            fill="#E20816"
            d="M4171 1400 c-1 -8 -12 -41 -25 -72 -13 -32 -20 -55 -15 -53 12 8 50
116 45 129 -2 6 -5 4 -5 -4z"
          />
          <path
            d="M3401 1329 c-6 -28 -10 -54 -7 -56 2 -2 9 19 15 48 6 28 10 54 7 56
-2 2 -9 -19 -15 -48z"
          />
          <path
            d="M2770 1367 c0 -3 21 -22 48 -43 26 -21 38 -28 27 -15 -21 24 -75 66
-75 58z"
          />
          <path d="M2761 1324 c13 -17 26 -30 28 -27 3 2 -8 16 -24 31 l-28 27 24 -31z" />
          <path
            fill="#E20816"
            d="M3487 1305 c-9 -20 -17 -41 -17 -48 0 -7 9 8 20 32 24 52 21 66 -3
16z"
          />
          <path
            d="M3710 1316 c-19 -13 -48 -39 -65 -57 l-30 -34 35 31 c19 17 53 43 75
58 22 14 35 26 30 25 -6 0 -26 -11 -45 -23z"
          />
          <path
            d="M4041 1330 c-1 -8 -14 -43 -31 -77 -16 -35 -27 -63 -24 -63 10 0 66
130 61 142 -4 9 -6 8 -6 -2z"
          ...
          <path
            fill="#E20816"
            d="M3776 1176 c-31 -35 -56 -67 -56 -70 0 -3 19 16 43 42 61 68 81 92
75 92 -3 0 -31 -29 -62 -64z"
          />
          <path
            d="M3820 1161 c-19 -11 -44 -29 -55 -41 -12 -14 1 -8 35 15 77 52 82 59
20 26z"
          />
          <path
            className=""
            fill="#E20816"
            d="M3243 1130 c0 -25 2 -35 4 -22 2 12 2 32 0 45 -2 12 -4 2 -4 -23z"
          />
          <path
            d="M3344 1095 c-6 -27 -14 -59 -18 -70 -3 -11 3 -1 14 23 12 24 20 55
18 70 -2 21 -5 16 -14 -23z"
          />
          <path
            d="M3814 1008 c-22 -24 -47 -52 -55 -63 -26 -37 17 3 62 56 50 60 47 63
-7 7z"
          />
          <path
            d="M3490 959 c-18 -42 -81 -138 -125 -191 -21 -23 -13 -18 16 14 50 52
137 193 126 204 -2 3 -10 -9 -17 -27z"
          ...
          <path
            d="M2981 930 c0 -3 6 -25 13 -50 8 -25 15 -36 15 -25 0 17 -26 88 -28
75z"
          />
          <path
            d="M1655 862 c-11 -20 -35 -47 -54 -59 -19 -13 -29 -23 -23 -23 17 0 72
50 88 82 22 43 12 43 -11 0z"
          />
          <path
            fill="#E20816"
            d="M3171 839 c-12 -35 -21 -70 -20 -78 0 -9 11 18 24 59 29 90 26 106
-4 19z"
          />
          <path
            d="M3298 873 c-25 -27 -58 -84 -58 -100 0 -4 12 12 26 37 14 25 35 55
46 68 12 12 19 22 17 22 -3 0 -17 -12 -31 -27z"
          />
          <path
            fill="#E20816"
            d="M3860 823 c-46 -47 -49 -51 -17 -28 32 24 86 85 75 85 -2 0 -28 -25
-58 -57z"
          />
          <path d="M1828 863 c12 -2 30 -2 40 0 9 3 -1 5 -23 4 -22 0 -30 -2 -17 -4z" />
          <path
            d="M1998 857 c-12 -5 -43 -6 -68 -4 l-45 6 35 -13 c24 -9 43 -10 60 -4
14 6 61 10 105 10 91 -1 90 5 -2 10 -33 2 -72 0 -85 -5z"
          />
          <path
            fill="#E20816"
            d="M3053 795 c0 -38 2 -53 4 -32 2 20 2 52 0 70 -2 17 -4 1 -4 -38z"
          />
          <path
            d="M1005 806 c-71 -23 -139 -48 -150 -55 l-20 -13 20 7 c11 4 80 27 154
51 120 39 163 56 135 53 -5 0 -67 -20 -139 -43z"
          />
          <path
            d="M1416 837 c3 -10 15 -22 25 -27 29 -16 123 -12 145 6 18 15 18 15 -3
5 -12 -6 -45 -11 -74 -11 -41 0 -58 5 -76 22 -19 18 -23 19 -17 5z"
          />
          <path
            d="M2951 810 c-1 -3 12 -37 29 -75 16 -39 29 -63 29 -55 0 15 -56 140
-58 130z"
          />
          <path
            d="M3490 771 c-19 -11 -55 -38 -80 -60 l-45 -42 66 48 c36 27 74 53 85
60 29 18 13 14 -26 -6z"
          />
          <path
            d="M845 715 c-16 -14 -45 -30 -63 -36 -18 -6 -31 -13 -29 -16 9 -8 91
33 111 56 25 28 18 26 -19 -4z"
          />
          <path d="M3141 724 c0 -11 3 -14 6 -6 3 7 2 16 -1 19 -3 4 -6 -2 -5 -13z" />
          <path
            d="M3946 715 c-61 -26 -88 -43 -48 -30 35 10 128 54 117 54 -5 0 -37
-11 -69 -24z"
          />
          <path
            fill="#E20816"
            d="M3212 620 c0 -19 2 -27 5 -17 2 9 2 25 0 35 -3 9 -5 1 -5 -18z"
          />
          <path
            d="M3548 634 c-27 -8 -48 -17 -48 -20 0 -4 8 -3 18 1 9 4 44 13 77 20
37 8 49 13 30 14 -16 0 -51 -7 -77 -15z"
          />
          <path d="M3465 600 c-3 -6 1 -7 9 -4 18 7 21 14 7 14 -6 0 -13 -4 -16 -10z" />
          <path
            d="M3782 589 c-35 -11 -62 -22 -60 -24 5 -5 138 34 138 40 0 8 -10 5
-78 -16z"
          />
          <path d="M2478 533 c12 -2 30 -2 40 0 9 3 -1 5 -23 4 -22 0 -30 -2 -17 -4z" />
          <path
            d="M2660 523 c8 -3 34 -14 58 -24 23 -10 42 -16 42 -14 0 9 -80 45 -97
44 -14 0 -15 -2 -3 -6z"
          />
          <path
            d="M2721 526 c8 -7 99 -35 99 -30 0 8 -67 34 -86 34 -10 0 -15 -2 -13
-4z"
          />
          <path d="M3581 506 c2 -2 42 -6 89 -8 47 -3 74 -2 60 2 -25 8 -157 13 -149 6z" />
          <path
            d="M3675 433 c11 -3 39 -11 62 -18 24 -7 41 -10 38 -5 -5 8 -87 31 -107
29 -7 -1 -4 -4 7 -6z"
            fill="#E20816"
          />
        </g>

import ModernInput from "../ui/Input/Input";
  ...
  return (
    <div className="pl-[9%] mt-20">
      ...
      <div className=" flex items-center justify-center gap-10">
        <div className="  flex-1 flex flex-col mt-10 gap-10">
          <ModernInput label="Enter item's UID" type="text" InputId="iteUID" />

          <ModernInput
            label="Enter item's Name"
            type="text"
            InputId="ItemName"
          />
          <div>
